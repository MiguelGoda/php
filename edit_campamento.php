...
<?php
   $tra=new User();
$datos=$tra->get_tabla_id("id_campamento",$_GET["id"],"campamento");
  ...
  <div class="content">
    ...
    <table width="374" border="0" align="center">
      ...
      <tr>
        ...
        <td width="198"><input name="nombre" type="text" size="35" value="<?php echo $datos[0]["nombre"];?>" required placeholder="nombre" /></td>
      </tr>
      <tr>
        <td>Descripcion</td>
        <td><input name="descripcion" type="text" size="35"  value="<?php echo $datos[0]["descripcion"];?>" /></td>
      </tr
