...
<table width="1000" height="153" border="0" align="center">
  <tr>
    ...
    <td width="1000"><img src="images/banner2.png" alt="San Pedro" width="990" height="70" /></td>
    <td width="62">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td >
			<script type="text/javascript" src="MenuUser.js"> 
			var aux='<?php echo $nom[0]["nombres"]; ?>'; 
            var aux2='admin';
            </script>	</td>
    <td>&nbsp;</td>
  </tr>
