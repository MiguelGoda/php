...
function initCalendar() {
    ...
    //heading table
	str += '<table class="calendar" border="1" cellspacing="0" cellpadding="0"><tr><th width="50%" class="sinborde">';
    str += '<form method="NONE" onsubmit="return 0">';
    str += '<a href="javascript:month--; initCalendar();">&laquo;</a> ';
    str += '<select class="cajacodigo" style="width:70px" id="select_month" name="monthsel" onchange="month = parseInt(document.getElementById(\'select_month\').value); initCalendar();">';
    for (i =0; i < 12; i++) {
    ...
    str += '</form>';
    str += '</th><th width="50%"  class="sinborde">';
    str += '<form method="NONE" onsubmit="return 0">';
    str += '<a href="javascript:year--; initCalendar();">&laquo;</a> ';
    str += '<select  class="cajacodigo" style="width:70px" id="select_year" name="yearsel" onchange="year = parseInt(document.getElementById(\'select_year\').value); initCalendar();">';
    ...
    str += '<table class="calendar"  border="1" cellspacing="2" cellpadding="2"><tr  class="tdcaract" style="text-transform:none;height:20px">';
    for (i = 0; i < 7; i++) {
        str += "<th  class='sinborde'>" + day_names[i] + "</th>";
    }
    str += "</tr>";
...
function gourl(){
    document.title = "Ca(r)gando página...";
...
function TD_onmouseover(){
	var tdele=window.event.srcElement.parentElement;
	tdele.style.backgroundColor="#EFF4FA";
	}
